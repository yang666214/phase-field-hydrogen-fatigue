...
D_L      = 2e-4          # mm^2/s   (adjust) 2e-4
rho_M    = 7.85e-6       # kg/mm^3  (steel)
M_H      = 1.008e-3      # kg/mol
Cwppm    = 0 #0.571         #55 MPa = 0.571 wt-ppm            # wt-ppm of hydrogen at the gas-exposed TOP edge (adjust)
k_mov    = 1e5           # numerical parameter
phi_th   = 0.95 
...
# whole = External boundary, notch = Pre-crack
  # C = C_env_fun
  [./C_on_mid_left]
